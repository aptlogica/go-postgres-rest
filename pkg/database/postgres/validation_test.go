...
func ExampleValidateTableName() {
	...
	if err := ValidateColumnName("user_id"); err != nil {
	...
	if err := ValidateTableName("users; DROP TABLE users; --"); err != nil {
