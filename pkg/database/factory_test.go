...
func TestDatabaseConnectorFactoryCreateConnection(t *testing.T) {
	...
	factory.RegisterConnector("postgres", NewPostgresConnectionFactory(dsnBuilder, conn))
...
func TestPostgresConnectionFactoryCreateConnection(t *testing.T) {
	...
	t.Run("builder error", func(t *testing.T) {
		...
		factory := NewPostgresConnectionFactory(builder, &mockConnector{})
	...
	t.Run("connect error", func(t *testing.T) {
		...
		factory := NewPostgresConnectionFactory(builder, conn)
...
var _ ConnectionFactory = (*PostgresConnectionFactory)(nil)
